...
var numOfVideo = 0
let list_of_videos = ["test_cap-and-tony_oklabal_adap0_modDepth=0.0625_minLval=0.3_minModVal=0.025_redByVal=0.02_screenBorderPixels=12.mp4", "test_james-bond-macau-dark_oklabal_adap4_modDepth=0.06_minLval=0.3_minModVal=0.025_redByVal=0.02_screenBorderPixels=12.mp4", "test_stranger-things-fashion_oklabal_adap0_modDepth=0.0525_minLval=0.3_minModVal=0.025_redByVal=0.02_screenBorderPixels=12.mp4", "test_rocky-steps-cropped_oklabal_adap0_modDepth=0.0625_minLval=0.3_minModVal=0.025_redByVal=0.02_screenBorderPixels=12.mp4", "test_big-buck-long-clip_oklabal_adap0_modDepth=0.0625_minLval=0.3_minModVal=0.025_redByVal=0.02_screenBorderPixels=12.mp4"]
